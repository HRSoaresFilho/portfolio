...
<body>
    <nav class="navbar navbar-dark bg-dark-mobile navbar-expand-md fixed-top-desktop">
        <div class="container my-2">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="https://github.com/HRSoaresFilho/" target="_blank"><i
                                class="fa-brands fa-github fa-lg"></i></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="https://www.linkedin.com/in/hrsoaresfilho/" target="_blank"><i
                                class="fa-brands fa-linkedin fa-lg"></i></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="mailto:hr.soaresfilho@gmail.com" target="_blank"><i
                                class="fa-solid fa-envelope fa-lg"></i></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="https://wa.me/5548988643890/" target="_blank"><i
        ...
        <div class="container hero">
            <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
                <div class="col-12 col-lg-6">
                    <img src="dist/img/astronauta-hero.png" class="d-block mx-lg-auto img-fluid ms-auto me-auto"
                        alt="Dev Humberto Filho" width="400" loading="lazy">
                </div>
                <div class="col-12 col-lg-6">
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-start mt-5">
                        <a class="btn btn-warning btn-lg px-4 me-md-2 cta" href="https://wa.me/5548988643890/"
                            target="_blank">
                            Contato</a>
    ...
    <section id="contact">
        <div class="container">
            ...
            <div class="row">
                <div class="col-6"><img src="dist/img/astronauta-contato.jpg" width="400" alt=""></div>
                <div class="col-6">
                    <form action="">
                        <div class="mb-3">
